...
import_aggregated_data:
	...
	./bin/importer_aggregated_data.sh aggregated_transactions_from_min_20_tx aggregated_transactions_from_min_20_tx.csv
	...
	./bin/importer_aggregated_data.sh aggregated_transactions_to_min_20_tx aggregated_transactions_to_min_20_tx.csv
